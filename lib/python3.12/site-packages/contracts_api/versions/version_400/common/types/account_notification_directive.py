...
class AccountNotificationDirective(types_utils.ContractsLanguageDunderMixin):
    def __init__(
        self,
        *,
        ...
        return types_utils.ClassSpec(
            ...
            constructor=types_utils.ConstructorSpec(
                docstring="""
                        ...
                        Notification must be defined in the
                        [notification_types](/reference/contracts/contracts_api_4xx/smart_contracts_api_reference4xx/metadata/#notification_types) list.""",  # noqa: E501
