    ...
    def _spec(cls, language_code=symbols.Languages.ENGLISH):
        ...
        return types_utils.ClassSpec(
            ...
            docstring="""
                ...
                constraint equivalent, see _Parameter shape to constraint mapping_ in the 
...
class UnionItem(types_utils.ContractsLanguageDunderMixin):
    ...
    def _spec(cls, language_code=symbols.Languages.ENGLISH):
        ...
        return types_utils.ClassSpec(
            name="UnionItem",
            docstring=f"Specifies a permissible value inside a [UnionShape]({_common_docs_path}classes/#UnionShape).",  # noqa E501
            constructor=types_utils.ConstructorSpec(
...
class UnionItemValue(types_utils.ContractsLanguageDunderMixin):
    ...
    def _spec(cls, language_code=symbols.Languages.ENGLISH):
        ...
        return types_utils.ClassSpec(
            name="UnionItemValue",
            docstring=f"""
            A wrapper for the key of a [UnionItem]({_common_docs_path}classes/#UnionItem). Used as the
            value type for [UnionShape]({_common_docs_path}classes/#UnionShape) parameter (see
            [ParameterTimeseries]({_common_docs_path}classes/#ParameterTimeseries) and [DerivedParameterHookResult]
            ({_common_docs_path}classes/#DerivedParameterHookResult)).
            """,  # noqa E501
