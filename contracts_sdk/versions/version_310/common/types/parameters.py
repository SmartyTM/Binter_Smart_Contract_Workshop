...
class NumberShape(parameters300.NumberShape):
    ...
    def validate_value(cls, value):
        if not decimal.Decimal._type_check(value) and not isinstance(value, int):
        ...
        return [
            ...
            types_utils.ValueSpec(
                ...
                docstring="""
                    ...
                    Parameters, and will only be used if an Account conversion performed via 
                    v1/account-migrations converts an Account to a Product Version that introduces
