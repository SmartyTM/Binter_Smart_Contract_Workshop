        ...
        return [
            ...
            types_utils.ValueSpec(
                ...
                docstring="""
                    ...
                    before they are referenced in a Supervisor Contract. Vault Core environments
                    with the Multiple Processing Groups optional add-on enforce this on Supervisor
                    Contract Version creation. The tag IDs are global in Vault and must exactly
                    match the tag IDs created in the Scheduler. [EventTypes](#classes-EventType)
                    in different Contracts with the same tag will be linked together. This defaults
                    to no tags if a tag ID is not provided.
                """,
            ),
            types_utils.ValueSpec(
