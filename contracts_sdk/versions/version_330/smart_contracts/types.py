        ...
        return [
            ...
            types_utils.ValueSpec(
                ...
                docstring="""
                    ...
                    tag IDs created in the Scheduler. [EventType](#classes-EventType)s in different
                    contracts with the same tag will be linked together. Defaults to no tags if a
