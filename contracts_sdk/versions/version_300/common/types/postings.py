            ...
            constructor=types_utils.ConstructorSpec(
                ...
                args=[
                    ...
                    types_utils.ValueSpec(
                        ...
                        type="Optional[datetime]",
                        docstring="""
                            The logical timestamp at which the batch takes effect.
                            Only backdating of posting instructions is supported; this means that
                            you cannot set them to be in the future, as determined by the clock of
                            the ledger service.
                        """,
                    ),
                    types_utils.ValueSpec(
