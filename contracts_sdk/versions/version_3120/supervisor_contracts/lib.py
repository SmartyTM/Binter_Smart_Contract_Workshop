...
class VaultFunctionsABC(v3110_lib.VaultFunctionsABC):
    ...
    def _spec(cls, language_code=symbols.Languages.ENGLISH):
        ...
        spec.public_methods["instruct_notification"] = types_utils.MethodSpec(
            ...
            docstring="""
                    Instructs the publishing of a notification. Notification must be defined in the
                    [notification_types](/reference/contracts/contracts_api_3xx/supervisor_contracts_api_reference3xx/metadata/#notification_types) list."""  # noqa: E501
